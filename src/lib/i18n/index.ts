import { useLanguage, type LanguageCode } from "../language";

// Surface modules. Each module owns its own keys and ships EN / ES /
// SV tables. We re-export them from this index in three merged
// objects so consumers can `useT()` against the union of all keys
// without knowing which surface a particular string belongs to.
//
...
/** Component-friendly wrapper that re-renders when the language changes. */

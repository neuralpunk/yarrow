...
export const appshellEN = {
  ...
  // Persona Actions popover (clicked from status-bar pill)
  "appshell.personaActions.title": "Persona actions",
  "appshell.personaActions.searchPlaceholder": "Search persona actions…",
  "appshell.personaActions.escHint": "esc",
  "appshell.personaActions.empty": "No matching action.",
  "appshell.personaActions.switchPersona": "Switch persona…",
  "appshell.personaActions.commandPalette": "Open command palette…",
  "appshell.personaActions.writer.streak": "Writing streak",
  "appshell.personaActions.researcher.questions": "Open questions",
  "appshell.personaActions.researcher.sources": "Sources list",
  "appshell.personaActions.researcher.newSource": "+ New source",
  "appshell.personaActions.developer.decisions": "Decision log",
  "appshell.personaActions.developer.newAdr": "+ New ADR",
  "appshell.personaActions.developer.codeHighlightOn": "Turn on code highlighting",
  "appshell.personaActions.developer.codeHighlightOff": "Turn off code highlighting",
  "appshell.personaActions.clinician.sensitive": "Sensitive notes",
  "appshell.personaActions.clinician.followUps": "Follow-ups",
  "appshell.personaActions.clinician.sessionKit": "+ New session note",
  "appshell.personaActions.cooking.recipes": "Recipes library",
  "appshell.personaActions.cooking.cookModeOn": "Enter cook mode",
  "appshell.personaActions.cooking.cookModeOff": "Exit cook mode",
  "appshell.personaActions.cooking.clip": "Clip recipe",

  // Status bar
  "appshell.status.modePillTitle": "Active persona: {mode} — click for actions",
...
export const appshellES: Record<AppshellKey, string> = {
  ...
  "appshell.personaActions.title": "Acciones de persona",
  "appshell.personaActions.searchPlaceholder": "Buscar acciones de persona…",
  "appshell.personaActions.escHint": "esc",
  "appshell.personaActions.empty": "Sin coincidencias.",
  "appshell.personaActions.switchPersona": "Cambiar persona…",
  "appshell.personaActions.commandPalette": "Abrir paleta de comandos…",
  "appshell.personaActions.writer.streak": "Racha de escritura",
  "appshell.personaActions.researcher.questions": "Preguntas abiertas",
  "appshell.personaActions.researcher.sources": "Lista de fuentes",
  "appshell.personaActions.researcher.newSource": "+ Nueva fuente",
  "appshell.personaActions.developer.decisions": "Registro de decisiones",
  "appshell.personaActions.developer.newAdr": "+ Nuevo ADR",
  "appshell.personaActions.developer.codeHighlightOn": "Activar resaltado de código",
  "appshell.personaActions.developer.codeHighlightOff": "Desactivar resaltado de código",
  "appshell.personaActions.clinician.sensitive": "Notas sensibles",
  "appshell.personaActions.clinician.followUps": "Seguimientos",
  "appshell.personaActions.clinician.sessionKit": "+ Nueva nota de sesión",
  "appshell.personaActions.cooking.recipes": "Biblioteca de recetas",
  "appshell.personaActions.cooking.cookModeOn": "Entrar en modo cocina",
  "appshell.personaActions.cooking.cookModeOff": "Salir del modo cocina",
  "appshell.personaActions.cooking.clip": "Recortar receta",

  // Status bar
  "appshell.status.modePillTitle": "Persona activa: {mode} — clic para acciones",
...
export const appshellSV: Record<AppshellKey, string> = {
  ...
  // Persona Actions popover
  "appshell.personaActions.title": "Persona-åtgärder",
  "appshell.personaActions.searchPlaceholder": "Sök persona-åtgärder…",
  "appshell.personaActions.escHint": "esc",
  "appshell.personaActions.empty": "Inga matchande åtgärder.",
  "appshell.personaActions.switchPersona": "Byt persona…",
  "appshell.personaActions.commandPalette": "Öppna kommandopalett…",
  "appshell.personaActions.writer.streak": "Skrivstreck",
  "appshell.personaActions.researcher.questions": "Öppna frågor",
  "appshell.personaActions.researcher.sources": "Källista",
  "appshell.personaActions.researcher.newSource": "+ Ny källa",
  "appshell.personaActions.developer.decisions": "Beslutslogg",
  "appshell.personaActions.developer.newAdr": "+ Ny ADR",
  "appshell.personaActions.developer.codeHighlightOn": "Slå på kodfärgning",
  "appshell.personaActions.developer.codeHighlightOff": "Stäng av kodfärgning",
  "appshell.personaActions.clinician.sensitive": "Känsliga anteckningar",
  "appshell.personaActions.clinician.followUps": "Uppföljningar",
  "appshell.personaActions.clinician.sessionKit": "+ Ny sessionsanteckning",
  "appshell.personaActions.cooking.recipes": "Receptbibliotek",
  "appshell.personaActions.cooking.cookModeOn": "Starta matlagningsläge",
  "appshell.personaActions.cooking.cookModeOff": "Avsluta matlagningsläge",
  "appshell.personaActions.cooking.clip": "Klipp recept",

  // Status bar
  "appshell.status.modePillTitle": "Aktiv persona: {mode} — klicka för åtgärder",
